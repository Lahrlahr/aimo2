...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    ...
    b" \x01(\t\x12/\n\x04\x61rgs\x18\x02"
    b" \x03(\x0b\x32!.kaggle_evaluation_client.Payload\x12M\n\x06kwargs\x18\x03"
    b" \x03(\x0b\x32=.kaggle_evaluation_client.KaggleEvaluationRequest.KwargsEntry\x1aP\n\x0bKwargsEntry\x12\x0b\n\x03key\x18\x01"
    b" \x01(\t\x12\x30\n\x05value\x18\x02"
    b' \x01(\x0b\x32!.kaggle_evaluation_client.Payload:\x02\x38\x01"N\n\x18KaggleEvaluationResponse\x12\x32\n\x07payload\x18\x01'
    b' \x01(\x0b\x32!.kaggle_evaluation_client.Payload"\x8d\x04\n\x07Payload\x12\x13\n\tstr_value\x18\x01'
    b" \x01(\tH\x00\x12\x14\n\nbool_value\x18\x02"
    b" \x01(\x08H\x00\x12\x13\n\tint_value\x18\x03"
    b" \x01(\x12H\x00\x12\x15\n\x0b\x66loat_value\x18\x04"
    b" \x01(\x02H\x00\x12\x14\n\nnone_value\x18\x05"
    b" \x01(\x08H\x00\x12;\n\nlist_value\x18\x06"
    b" \x01(\x0b\x32%.kaggle_evaluation_client.PayloadListH\x00\x12<\n\x0btuple_value\x18\x07"
    b" \x01(\x0b\x32%.kaggle_evaluation_client.PayloadListH\x00\x12:\n\ndict_value\x18\x08"
    b" \x01(\x0b\x32$.kaggle_evaluation_client.PayloadMapH\x00\x12"
    b" \n\x16pandas_dataframe_value\x18\t \x01(\x0cH\x00\x12"
    b" \n\x16polars_dataframe_value\x18\n"
    b" \x01(\x0cH\x00\x12\x1d\n\x13pandas_series_value\x18\x0b"
    b" \x01(\x0cH\x00\x12\x1d\n\x13polars_series_value\x18\x0c"
    b" \x01(\x0cH\x00\x12\x1b\n\x11numpy_array_value\x18\r"
    b" \x01(\x0cH\x00\x12\x1c\n\x12numpy_scalar_value\x18\x0e"
    b" \x01(\x0cH\x00\x12\x18\n\x0e\x62ytes_io_value\x18\x0f"
    b' \x01(\x0cH\x00\x42\x07\n\x05value"B\n\x0bPayloadList\x12\x33\n\x08payloads\x18\x01'
    b' \x03(\x0b\x32!.kaggle_evaluation_client.Payload"\xad\x01\n\nPayloadMap\x12I\n\x0bpayload_map\x18\x01'
    b" \x03(\x0b\x32\x34.kaggle_evaluation_client.PayloadMap.PayloadMapEntry\x1aT\n\x0fPayloadMapEntry\x12\x0b\n\x03key\x18\x01"
    b" \x01(\t\x12\x30\n\x05value\x18\x02"
    b' \x01(\x0b\x32!.kaggle_evaluation_client.Payload:\x02\x38\x01\x32\x8a\x01\n\x17KaggleEvaluationService\x12o\n\x04Send\x12\x31.kaggle_evaluation_client.KaggleEvaluationRequest\x1a\x32.kaggle_evaluation_client.KaggleEvaluationResponse"\x00\x62\x06proto3'
)
